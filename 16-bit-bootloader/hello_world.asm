[bits 16]             ; tell the assembler to produce 16 bit binary format
...
start:
	xor ax,ax
	mov ds,ax
	mov es,ax	; these 3 lines will clear the ax,ds,es registers
	mov bx,0x8000	; we will start from address
...
times (510 - ($ - $$)) db 0x00 ;set 512 $$ are 2 bytes, this tells the bios that this file contain bootloader components
dw 0xAA55	;boot signature tells bios that this file contains boot components that needs to be boot
